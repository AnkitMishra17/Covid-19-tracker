...
const Globalstats = lazy(() =>
  import("./components/globalstats/Globalstats.js")
);
const Countrystat = lazy(() =>
  import("./components/individualstats/Individual.js")
);
    ...
    <Router>
      <div className="App">
        ...
        <Suspense fallback={<Countryloader />}>
          <Route path="/country/:id" component={Countrystat}></Route>
        </Suspense>
      </div>
    </Router>
  );
